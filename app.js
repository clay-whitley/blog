...
app.get('/blog/add', secure, routes.postform);
app.post('/blog/add', secure, routes.addpost);
app.get('/blog/:id', routes.viewpost);
app.get('/blog/category/:cat', routes.viewcat);
app.get('/blog/:id/edit', secure, routes.updateform);
app.put('/blog/:id/update', secure, routes.updatepost);
app.get('/blog/:id/delete', secure, routes.deletepost);
